...
export class CreateTeamComponent implements OnInit {
  ...
  loadEditTeam() {
    this._playerService.getUserTeamInfo(this.user).subscribe(
      result=>{
          this.addDriver(result[this.indexTeam].nameDriver1, "");
          this.addDriver(result[this.indexTeam].nameDriver2, "");
          this.addDriver(result[this.indexTeam].nameDriver3, "");
          this.addDriver(result[this.indexTeam].nameDriver4, "");
          this.addDriver(result[this.indexTeam].nameDriver5, "");
  ...
  updateFormEdit(){
    this.addDeleteConstructor(this.nameCar, "", "add")
    this.formTeam1.patchValue({ teamName: this.nameTeam,
